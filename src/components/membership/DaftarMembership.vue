<template>
    <v-container>
        ...
        <v-row justify="center" class="pb-10" v-if="$vuetify.breakpoint.mdAndUp">
            ...
            <v-card class="pa-7" :class="`rounded${'-xl'}`" elevation="12">
                ...
                <v-row class="pl-2">
                    ...
                    <caption class="pt-6">/SELAMANYA</caption>
                </v-row>
                <v-row>
                    <v-col cols="1">
                        <v-icon>
                    ...
                    <v-col>
                        <p>Akses ke buku yang bertanda gratis</p>
                    </v-col>
                </v-row>
                <v-row>
                    <v-col cols="1">
                    ...
                    <v-col>
                        <p>Dua buku per hari untuk buku premium dengan fitur eksklusif (animasi audio, sensori interaktif)</p>
                    </v-col>
                </v-row>
                <v-row>
                    <v-col cols="1">
                    ...
                    <v-col>
                        <p>Maksimal dua kenaikan level tiap hari pada game</p>
                    </v-col>
                </v-row>
                <v-row>
                    <v-col cols="1">
                    ...
                    <v-col>
                        <p>Akses unlimited ke buku premium yang telah dibeli</p>
                    </v-col>
                </v-row>
                <v-row>
                    <v-col cols="1">
            ...
            <v-card class="pa-7" elevation="12" :class="`rounded${'-xl'}`">
                ...
                <v-row class="pl-2">
                    <p class="text-h3">Sesuai Durasi</p>
                </v-row>
                <v-row>
                    <v-col cols="1">
                        <v-icon
                ...
                <v-row>
                    ...
                    <v-col>
                        <p>Akses unlimited ke buku premium dengan fitur eksklusif (animasi audio, sensori interaktif)</p>
                    </v-col>
                </v-row>
                <v-row>
                    <v-col cols="1">
                    ...
                    <v-col>
                        <p>Kenaikan level unlimited pada game</p>
                    </v-col>
                </v-row>
                <v-row>
                    <v-col cols="1">
                    ...
                    <v-col>
                        <p>Akses otomatis ke forum komunitas Cerdasia</p>
                    </v-col>
                </v-row>
                <v-row>
                    <v-col cols="1">
                    ...
                    <v-col>
                        <p>Laporan perkembangan anak tiap minggu dan rekomendasi</p>
                    </v-col>
                </v-row>
                <v-row>
                    <v-col cols="1">
            ...
            <v-card class="pa-7" :class="`rounded${'-xl'}`" elevation="12">
                ...
                <v-row class="pl-2">
                    ...
                    <caption class="pt-6">/BUKU</caption>
                </v-row>
                <v-row>
                    <v-col cols="1">
                        <v-icon
        ...
        <div justify="center" class="pb-10" v-if="$vuetify.breakpoint.smAndDown">
            <v-card class="pa-7" :class="`rounded${'-xl'}`" elevation="12">
                <p style="color:#FF5E3C">Free Member</p>
                <v-row class="pl-2">
                    <p class="text-h3">Free</p>
